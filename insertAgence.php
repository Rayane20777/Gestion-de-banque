...
<div class="min-h-full">
    ...
    <form action="insertAgence.php" method="post" class="grid gap-4 grid-cols-2 border-b-4 border-gray-600 pb-4">
        ...
        <input type="text" id="bank_id" name="bank_id" class="pl-2 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 sm:text-sm sm:leading-6" required>
